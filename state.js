...
let scheduleHalfDay={};
let bjSchedule={};
// ledighetRequests[docId][dateStr] = true  (day-level)
// ledighetVeckor[docId][wkey] = true        (week-level)
let ledighetRequests={};
let ledighetVeckor={};
// utbildningDagar[docId][dateStr] = true  (day-level)
// utbildningVeckor[docId][wkey] = true     (week-level)
let utbildningDagar={};
